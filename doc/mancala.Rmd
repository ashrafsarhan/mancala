...
Mancala web game application architecture depends mainly on the messaging architecture using STOMP (Websockt Sub Protcol), Websockt provides full-duplex, two-way communication between client and server. <http://docs.spring.io/spring/docs/current/spring-framework-reference/html/websocket.html>
